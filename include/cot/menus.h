...
struct global_menu_info {
  ...
  int8_t menu_results[20]; // To store previous results of menus across update calls!
  int8_t window_ids[20]; // Maximum number of windows that can be active at a time.
