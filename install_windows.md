...
6. Download this repository by running `git clone --recursive https://github.com/Adex-8x/mm-rehearsal.git` in the MSYS2 terminal. c-of-time will be downloaded in a folder called `c-of-time` inside the current directory.
